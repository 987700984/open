<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:77:"D:\PHPTutorial\WWW\open\public/../application/admin\view\sorelevel\index.html";i:1530847480;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
            ...
            <div class="example-wrap">
                <div class="example">
                    <table id="cusTable" data-height="550">
                        <thead>
                        <th data-field="lid">角色ID</th>
                        <th data-field="level">币种名称</th>
                        <th data-field="name">角色名称</th>
                        <th data-field="min">最小积分</th>
                        <th data-field="interest">生息率(万分之)</th>
