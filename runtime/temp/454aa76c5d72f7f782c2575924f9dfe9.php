<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:72:"D:\PHPTutorial\WWW\open\public/../application/admin\view\agent\edit.html";i:1531128252;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-4">
                                <input id="uid" type="text" class="form-control" name="uid" required=""
                                       value="<?php echo $agent['uid']; ?>" disabled="disabled" >
                            </div>
                        </div>
                        ...
                        <div class="form-group" >
                            ...
                            <div class="input-group col-sm-4">
                                <select id="level" class="form-control" name="level">
                                    ...
                                    <option value="<?php echo $vo['id']; ?>" <?php if($vo['id'] == $agent['level']): ?>selected="selected" <?php endif; ?>><?php echo $vo['name']; ?></option>
