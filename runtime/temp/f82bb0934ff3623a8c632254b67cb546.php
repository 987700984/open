<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:73:"D:\PHPTutorial\WWW\open\public/../application/admin\view\level\index.html";i:1531207536;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <div class="ibox float-e-margins">
        ...
        <div class="ibox-content">
            <div class="form-group clearfix col-sm-1">
                <a href="./add"><button class="btn btn-outline btn-primary" type="button">添加角色</button></a>
            </div>
            <!--搜索框开始-->
            ...
            <div class="example-wrap">
                <div class="example">
                    <table id="cusTable" data-height="550">
                        ...
                        <th data-field="commission1">一级好友返佣(%)</th>
                        <th data-field="commission2">二级好友返佣(%)</th>
                        <th data-field="commission5">一级代理返佣(%)</th>
                        <th data-field="commission4">二级代理返佣(%)</th>
                        <th data-field="commission3">三级代理返佣(%)</th>
                        <th data-field="sid">币种</th>
                        <th data-field="max_num">可拥有下级最大数量(个)</th>
