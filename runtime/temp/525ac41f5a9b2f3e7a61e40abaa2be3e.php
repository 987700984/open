<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:74:"D:\PHPTutorial\WWW\open\public/../application/admin\view\message\edit.html";i:1530093726;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                    ...
                    <form class="form-horizontal m-t" id="commentForm" method="post" onsubmit="return toVaild()">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-8">
                                <textarea id="articlecontent" name="tip" style="width:100%;height:400px;"><?php echo $cfg['tip']; ?></textarea>
                            </div>
                        </div>
