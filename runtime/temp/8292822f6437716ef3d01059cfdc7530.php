<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:73:"D:\PHPTutorial\WWW\open\public/../application/admin\view\user\center.html";i:1528004698;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                    ...
                    <form class="form-horizontal m-t" id="commentForm" method="post" onsubmit="return toVaild()">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-4">
                                <input id="username" type="text" class="form-control" name="username" required="" value="<?php echo $res['username']; ?>" aria-required="true">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="fileinput fileinput-new" data-provides="fileinput"  id="exampleInputUpload">
                                <div class="fileinput-new thumbnail" style="width: 200px;height: auto;max-height:150px;">
                                    <img id='picImg' style="width: 100%;height: auto;max-height: 140px;" src="<?php if($res['pic']): ?><?php echo $res['pic']; else: ?>__IMG__/profile_small.png<?php endif; ?>" alt="" />
                                </div>
                                ...
                                <div>
                                    <span class="btn btn-primary btn-file">
                                        ...
                                        <input type="file" value="<?php echo $res['pic']; ?>" name="pic1" id="picID" accept="image/gif,image/jpeg,image/x-png"  />
                                    </span>
