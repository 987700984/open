<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:67:"D:\PHPTutorial\WWW\open\public/../application/admin\view\login.html";i:1532672519;}*/ ?>
<!DOCTYPE html>
<html lang="en">
        ...
        <div class="yy-main">
            <div class="yy-content">
                <div class="yy-box clearfix">
                    ...
                    <div class="qr-box"><img src="/static/admin/images/qr_code_img.png" alt="二维码"><p>扫描二维码下载WE Token</p></div>
                </div>
