<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:76:"D:\PHPTutorial\WWW\open\public/../application/notice\view\notice\config.html";i:1529977388;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                ...
                <div class="ibox-content">
                    <form class="form-horizontal m-t" id="commentForm" method="post" onsubmit="return toVaild()">
                        ...
                        <div class="form-group">
                            <label class="col-sm-2 control-label">播放频率(分钟)：</label>
                            <div class="input-group col-sm-8">
                                <input id="notice" type="text" class="form-control" name="time" required="" aria-required="true" value="<?php echo $cfg['time']; ?>">
                            </div>
                        </div>
