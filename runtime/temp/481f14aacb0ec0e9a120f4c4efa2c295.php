<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:80:"D:\PHPTutorial\WWW\open\public/../application/soretype\view\soretype\config.html";i:1529977388;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                ...
                <div class="ibox-content">
                    <form class="form-horizontal m-t" id="commentForm" method="post" onsubmit="return toVaild()">
                        ...
                        <div class="form-group">
                            <label class="col-sm-2 control-label">糖果中心状态：</label>
                            <div class="input-group col-sm-4">
                                <select class="form-control" name="status" required="" aria-required="true">
                                    <option value="1" <?php if($cfg['status'] == 1): ?>selected<?php endif; ?>>启用</option>
                                    <option value="0" <?php if($cfg['status'] == 0): ?>selected<?php endif; ?>>禁用</option>
                                </select>
                            </div>
                        </div>
