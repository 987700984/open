<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:70:"D:\PHPTutorial\WWW\open\public/../application/admin\view\coin\add.html";i:1533708971;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                    ...
                    <form class="form-horizontal m-t" id="commentForm" method="post" onsubmit="return toVaild()">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-4">
                                <input id="uid" type="number" class="form-control" name="uid" required="" aria-required="true">
                            </div>
                        </div>
