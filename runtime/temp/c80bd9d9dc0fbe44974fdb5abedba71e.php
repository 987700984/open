<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:75:"D:\PHPTutorial\WWW\open\public/../application/admin\view\message\index.html";i:1529457981;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <div class="ibox float-e-margins">
        ...
        <div class="ibox-content">
            <div class="form-group clearfix col-sm-1">
                <a href="./edit"><button class="btn btn-outline btn-primary" type="button">编辑</button></a>
            </div>
            <!--搜索框开始-->
                ...
                <div class="content clearfix m-b">
                    <div class="form-group">
                        ...
                        <select name="type" id="type">
                            <?php if(is_array($type) || $type instanceof \think\Collection): $i = 0; $__LIST__ = $type;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
