<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:79:"D:\PHPTutorial\WWW\open\public/../application/integral\view\integral\index.html";i:1530355570;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
            ...
            <div class="example-wrap">
                <div class="example">
                    <table id="cusTable" data-height="550">
                        ...
                        <th data-field="name">糖果名称</th>
                        <th data-field="username">用户名称</th>
                        <th data-field="phone">用户手机号</th> 
                        <th data-field="integral">数量</th>
                        <th data-field="money">挖矿总数</th>
