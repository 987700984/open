<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:77:"D:\PHPTutorial\WWW\open\public/../application/admin\view\agent\money_log.html";i:1533979402;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <div class="ibox float-e-margins">
        <div class="ibox-title">
            ...
            <div class="content clearfix m-b" style="float: right">
                <label>返佣金额：</label> <span id="fang"></span><label style="margin-left: 20px;">提现金额：</label> <span id="tixian"></span><label style="margin-left: 20px;">收入金额：</label> <span id="shou"></span>
            </div>
        </div>
            ...
            <div class="example-wrap">
                <div class="example">
                    <table id="cusTable" data-height="550">
                        ...
                        <th data-field="username">会员名称</th>
                        <th data-field="content">资金类型</th>
                        <th data-field="agentid">下级UID</th>
                        <th data-field="mobile">下级手机号</th>
                        <th data-field="username">下级姓名</th>
...
//                    sid:$('#sid').val()
            ...
            onLoadSuccess: function(res){  //加载成功时执行
                $('#fang').html(res.fanyong);
                $('#tixian').html(res.tixian);
                $('#shou').html(res.order);
