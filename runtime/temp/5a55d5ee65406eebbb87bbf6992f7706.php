<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:73:"D:\PHPTutorial\WWW\open\public/../application/admin\view\user\detail.html";i:1530931005;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                ...
                <div class="ibox-content">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-4">
                                <span><?php echo !empty($user['rtid'])?$user['rtid2']:'0'; ?></span>
                            </div>
                        </div>
                        <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-4">
                                <span><?php echo !empty($user['ispay']) && $user['ispay']==1?'是':'否'; ?></span>
                            </div>
                        </div>
                    <div class="form-group">
                        <label class="col-sm-3 control-label">账号封禁：</label>
                        <div class="input-group col-sm-4">
                            <span><?php echo !empty($user['state']) && $user['state']==1?'是':'否'; ?></span>
                        </div>
                    </div>
                        <div class="form-group">
