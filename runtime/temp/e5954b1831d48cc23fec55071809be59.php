<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:80:"D:\PHPTutorial\WWW\open\public/../application/admin\view\agent\money_detail.html";i:1533622037;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
        ...
        <div class="ibox-content">
            ...
            <form id='commentForm' role="form" method="post" class="form-inline"  >
                ...
                <div class="form-group">
                    <a class="btn btn-primary" type="button" style="margin-top:5px" href="<?php echo url('agent/user_out',['id'=>$uid]); ?>"><strong>导 出</strong>
                    </a>
                </div>
