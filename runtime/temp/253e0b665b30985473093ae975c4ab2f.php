<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:73:"D:\PHPTutorial\WWW\open\public/../application/admin\view\black\index.html";i:1529457981;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<script type="text/javascript">
    ...
    function edit(id){
        layer.confirm('确认修改?', {icon: 3, title:'提示'}, function(index){
            //do something
            $.getJSON("<?php echo url('black/edit'); ?>", {'id' : id}, function(res){
                if(res.code == 0){
                    layer.alert('删除成功');
                    initTable();
                }else{
