<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:71:"D:\PHPTutorial\WWW\open\public/../application/shop\view\spec\index.html";i:1532427995;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>规格属性分类列表</title>
    ...
    <div class="ibox float-e-margins">
        ...
        <div class="ibox-content">
            <div class="form-group clearfix col-sm-1">
                 <a href="./add"><button class="btn btn-outline btn-primary" type="button">添加规格属性分类</button></a>
            </div>
            <!--搜索框开始-->
            <form id='commentForm' role="form" method="post" class="form-inline"  >
                <div class="content clearfix m-b">
                    <div class="form-group" style="margin-left:50px;">
                        <label>规格属性分类名称：</label>
                    ...
                    <div class="form-group" style="margin-left:30px;">
                       ...
                       <select class="form-control" id="level" name="level">
                           ...
                           <option value="<?php echo $vo['tid']; ?>"><?php echo $vo->cate->title; ?>-<?php echo $vo['goodsname']; ?></option>
            ...
            <div class="example-wrap">
                <div class="example">
                    <table id="cusTable" data-height="550">
                        <thead>
                        <th data-field="sid">ID</th>
                        <th data-field="spec_name">分类名称</th>
                        <th data-field="tid">所属模型</th>
...
<script type="text/javascript">
    ...
    function roleDel(id){
        layer.confirm('确认删除此规格属性分类?', {icon: 3, title:'提示'}, function(index){
            //do something
