<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:71:"D:\PHPTutorial\WWW\open\public/../application/admin\view\c2c\index.html";i:1532937697;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<script type="text/javascript">
    ...
    function edit(id){
        layer.confirm('确认修改此订单?', {icon: 3, title:'提示'}, function(index){
            //do something
            $.getJSON("<?php echo url('c2c/edit'); ?>", {'id' : id}, function(res){
                if(res.code == 1){
                    layer.alert(res.msg);
                    initTable();
                }else{
