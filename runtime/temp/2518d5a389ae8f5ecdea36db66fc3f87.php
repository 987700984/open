<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:67:"D:\PHPTutorial\WWW\open\public/../application/admin\view\index.html";i:1528004698;}*/ ?>
<!DOCTYPE html>
<html>
<head>
            ...
            <ul class="nav" id="side-menu">
                <li class="nav-header">
                    <div class="dropdown profile-element">
                        ...
                        <span><img alt="image" class="img-circle" src="<?php if($pic): ?><?php echo $pic; else: ?>__IMG__/profile_small.png<?php endif; ?>" style="width:64px;" /></span>
