<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:71:"D:\PHPTutorial\WWW\open\public/../application/bill\view\bill\index.html";i:1533613388;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
            ...
            <form id='commentForm' role="form" method="post" class="form-inline">
                <div class="content clearfix m-b">
                    <div class="form-group">
                        <label>币名称：</label>
                        <select name="soretype" id="billname" class="form-control">
            ...
            <div class="example-wrap">
                <div class="example">
                    <table id="cusTable" data-height="550">
                        ...
                        <th data-field="name">币名称</th>

                        <!-- <th data-field="ordersn">订单ID</th> -->

                        <th data-field="username">用户名称</th>
                        <th data-field="nickname">收款人</th>
                        <th data-field="type2">类型</th>
                        <th data-field="type">状态</th>
                        <th data-field="phone">用户手机</th> 
                        <th data-field="content">备注</th>   
                        <th data-field="price">数量</th> 
                        <th data-field="proc">手续费</th> 
...
<script type="text/javascript">
    ...
    function billDel(id){
        layer.confirm('确认删除此订单?', {icon: 3, title:'提示'}, function(index){
            //do something
            $.getJSON('./billDel', {'id' : id}, function(res){
                if(res.code == 0){
                    layer.alert('删除成功');
                    initTable();
                }else{
