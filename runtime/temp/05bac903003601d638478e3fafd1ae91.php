<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:73:"D:\PHPTutorial\WWW\open\public/../application/admin\view\agent\index.html";i:1531734710;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
            ...
            <form id='commentForm' role="form" method="post" class="form-inline"  >
                <div class="content clearfix m-b">
                    <div class="form-group" style="margin-left:50px;">
                        <label>会员代理名称(或者手机号或者会员ID)：</label>
            ...
            <div class="example-wrap">
                <div class="example">
                    <table id="cusTable" data-height="550">
                        ...
                        <th data-field="levelname">会员等级</th>
                        <th data-field="commission">累计代理佣金</th>
                        <th data-field="commission1">累计好友佣金</th>
                        <th data-field="money">剩余余额</th>
                        <th data-field="ice_money">冻结余额</th>
                        <th data-field="has_money">已提现余额</th>
                        <th data-field="add_time">成为代理时间</th>
