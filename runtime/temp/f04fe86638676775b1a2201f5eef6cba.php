<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:67:"D:\PHPTutorial\WWW\open\public/../application/admin\view\index.html";i:1532672519;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div id="wrapper">
            ...
            <ul class="nav" id="side-menu">
                <li class="nav-header">
                    <div class="dropdown profile-element">
                        ...
                        <span><img alt="image" class="img-circle" src="<?php if($pic): ?><?php echo $pic; else: ?>/static/admin/images/profile_small.png<?php endif; ?>" style="width:64px;" /></span>
                        ...
                        <ul class="dropdown-menu animated fadeInRight m-t-xs">
                            ...
                            <li>
                                <a class="J_menuItem" href="<?php echo url('admin/user/center'); ?>">个人中心</a>
    ...
    <div id="page-wrapper" class="gray-bg dashbard-1">
        ...
        <div class="footer">
            <div class="pull-right">Copyright &copy; 2016-2020  版权所有   深圳市比特信科技有限公司 
            </div>
        </div>
    </div>
    <!--右侧部分结束-->
