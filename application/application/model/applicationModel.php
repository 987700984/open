...
{
	protected $table = 'ims_tpapplication';
	 ...
	 * @param $limit
	 */
	public function getApplicationByWhere($where, $offset, $limit)
	{
     ...
     * @param $param
     */
    public function insertApplication($param)
    {
        try{
     ...
     * @param $param
     */
    public function editApplication($param)
    {
    	try{
    ...
    */
    public function category(){
        $sql = "select * from ims_tpapp_category where status = 1";
        $res = $this->query($sql);
        return $res;
    }
    ...
    */
    public function getApplicationcategory($id){
        $sql = "select * from ims_tpapp_category where id = ".$id;
        $res = $this->query($sql);
        return $res;
    }
