...
class Role extends Base
{
    ...
    public function roleAdd()
    {
        if(request()->isPost()){
            ...
            $this->log->addLog($this->logData,'进行了添加后台管理角色操作');
    ...
    public function roleEdit()
    {
        ...
        if(request()->isPost()){
            ...
            $this->log->addLog($this->logData,'进行了编辑后台管理角色操作');
            return json(['code' => $flag['code'], 'data' => $flag['data'], 'msg' => $flag['msg']]);
        }
    ...
    public function roleDel()
    {
        ...
        $this->log->addLog($this->logData,'进行了删除后台管理角色操作');
        return json(['code' => $flag['code'], 'data' => $flag['data'], 'msg' => $flag['msg']]);
    }
    ...
    public function giveAccess()
    {
        ...
        if('give' == $param['type']){
            ...
            $this->log->addLog($this->logData,'进行了后台管理角色分配权限操作');
            return json(['code' => $flag['code'], 'data' => $flag['data'], 'msg' => $flag['msg']]);
        }
    }
}