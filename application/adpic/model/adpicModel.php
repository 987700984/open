...
// +----------------------------------------------------------------------
namespace app\adpic\model;

use think\Model;

class adpicModel extends Model
{
	protected $table = 'ims_tpadpic';
	 ...
	 * @param $limit
	 */
	public function getAdpicByWhere($where, $offset, $limit)
	{
     ...
     * @param $param
     */
    public function insertAdpic($param)
    {
        try{
     ...
     * @param $param
     */
    public function editAdpic($param)
    {
    	try{
     ...
     * @param $articleid
     */
    public function getOneAdpic($id)
    {
