...
class Article extends Base
{
            ...
            if(count($selectResult) > 0){                   
                foreach($selectResult as $key=>$vo){
                    ...
                    $operate = [
                            ...
                            '编辑' => url('article/articleEdit', ['articleid' => $vo['id']]),
    ...
    {   
        ...
        if(request()->isPost()){
            ...
            $this->log->addLog($this->logData,'进行了文章添加操作');
    ...
    public function articleEdit()
    {
        ...
        if(request()->isPost()){
            ...
            $this->log->addLog($this->logData,'进行了文章编辑操作');
            return json(['code' => $flag['code'], 'data' => $flag['data'], 'msg' => $flag['msg']]);
        }
    ...
    public function articleDel()
    {
        ...
        $this->log->addLog($this->logData,'进行了文章删除操作');
        return json(['code' => $flag['code'], 'data' => $flag['data'], 'msg' => $flag['msg']]);
    }
}
